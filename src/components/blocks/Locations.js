...
import { LocationsClose } from '../../js/actions/'
...
class Locations extends Component{
	...
	handlerButton = () => (this.state.step1) ?  this.props.LocationsClose(this.props.LocationsOn) : this.setState({step1:true})
	...
	render(){
		...
		const Step2 = () =>
			...
			<ul className="regions slide_up_text">
				{RegionsEn}
			</ul>:
			<ul className="regions slide_up_text">
				{RegionsSp}
		...
		const ChoosePanel = () => 
			<div id="choose" className="choose--active">
				...
				<div className="title">
					{this.state.step1 ? "Choose language" : "Choose region"}
				</div>
